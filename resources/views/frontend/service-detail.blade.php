			...
			<div class="container">
				<header class="section-header-two text-left mb-2 d-flex">
					...
					<div class="all text-center mt-4">
						<a href="{{route('completedProjects')}}" class="button-one">View all <i class="fas fa-arrow-right ml-2"></i></a>
					</div>
				</header>
						...
						@foreach ($projects as $project)
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
								<div class="holder box-shadow-2 p-2">
									<a href="{{route('projectDetail', $project->id)}}" class="wrapper d-block box-shadow-2">
		...
		<section class="team-section gallery-single-section py-5 bg-light">
		    <div class="container">
		    	<header class="section-header-two mb-4 text-center">
	                ...
	                <h3 class="lg-title text-dark font-weight-bold">From {{ $serviceDetail->category_name }} Service</h3>
	            </header>
