	...
	<div class="about-page">
	    ...
	    <div class="page-banner">
	        <div class="container d-flex">
	            <h1 class="page-title lg-title flex-g-1">About Us</h1>
	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-7 col-12">
	                    ...
	                    <div class="content">
	                        ...
	                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Voluptates beatae est dolor tempore architecto aut quis dolores nobis, neque corrupti deleniti voluptatibus veritatis, facere delectus obcaecati, officiis tenetur dicta? Inventore. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae atque alias dignissimos dolorum quam non voluptates, esse ut voluptatum perferendis maxime dolorem exercitationem asperiores. Perspiciatis reiciendis animi optio, illum vitae.</p>
	                    </div>
	                </div>
	            </div>
	        </div>
	            ...
	            <div class="row">
	            	<div class="col-md-4 col-12 mb-md-0 mb-3">
		                <div class="wrapper box-shadow-2 p-md-4 p-2">
		                    ...
		                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim est debitis repellendus dolore cum, asperiores accusamus et, illo molestias sed quas reprehenderit, quasi reiciendis tenetur perferendis ea eius dicta quos.</p>
		                </div>
		            </div>
		            <!-- Mission -->
		            <div class="col-md-4 col-12 mb-md-0 mb-3">
				                ...
				                <div class="row">
				                    ...
				                    <div class="col-md-8 col-12">
				                        <div class="content xs-title px-md-0 px-2">
				                            <a href="cause-detail.php" class="sm-title text-black font-weight-bold">Raise Fund for Healthy Food</a>
			        ...
			        <div class="swiper-wrapper">
			            <div class="swiper-slide">
			                <div class="slider-wrapper">
			                    <img  class="lazy-image" src="assets/images/image-bg.svg" data-src="assets/images/clients/01.png" alt="">
			                </div>
			            </div> <!-- end swiper-slide -->
			            <div class="swiper-slide">
			                <div class="slider-wrapper">
			                    <img  class="lazy-image" src="assets/images/image-bg.svg" data-src="assets/images/clients/02.png" alt="">
			                </div>
			            </div> <!-- end swiper-slide -->
			            <div class="swiper-slide">
			                <div class="slider-wrapper">
			                    <img  class="lazy-image" src="assets/images/image-bg.svg" data-src="assets/images/clients/03.png" alt="">
			                </div>
			            </div> <!-- end swiper-slide -->
			            <div class="swiper-slide">
			                <div class="slider-wrapper">
			                    <img class="lazy-image"  src="assets/images/image-bg.svg" data-src="assets/images/clients/04.png" alt="">
			                </div>
			            </div> <!-- end swiper-slide -->
			            <div class="swiper-slide">
			                <div class="slider-wrapper">
