                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="product_name" id="product_name" value="{{old('product_name') ?? $product->product_name}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="product_description" style="font-size: 14px">Product Description</label>
                                        <textarea  class="form-control" type="text" name="product_description" id="product_description"> {{old('product_description') ?? $product->product_description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="discount" id="discount" value="{{old('discount') ?? $product->discount}}">
                                    </div>
                                </div>
