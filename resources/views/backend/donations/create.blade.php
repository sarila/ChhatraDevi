                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="donation_amount" id="donation_amount" value="{{old('donation_amount') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_method" id="payment_method" class="form-control">
                                            <option value= "0">Cash Donation</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" type="text" name="message" id="message" rows="9" required>{{old('message') }}</textarea> 
                                    </div>
                                </div>                             
                            </div>
                            <div class="col-md-12">
